...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PAGINATION_QUERY; });
function _templateObject() {
...
/* harmony default export */ var components_Pagination = __webpack_exports__["b"] = (Pagination_Pagination);
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_styles_Form__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
          ...
          disabled: loading,
          "aria-busy": loading
        }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("h2", null, "Sign into your account"), error && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_ErrorMessage__WEBPACK_IMPORTED_MODULE_5__[/* default */ "a"], {
          error: error
...
var DELTE_ITEM_MUTATION = external_graphql_tag_default()(_templateObject());
...
})(["display:grid;grid-template-columns:1fr 1fr;grid-gap:60px;max-width:", ";margin:0 auto;box-sizing:border-box;"], function (props) {
...
function (_Component) {
  ...
  Items_createClass(Items, [{
    key: "render",
    value: function render() {
      return external_react_default.a.createElement(Center, null, external_react_default.a.createElement(Pagination["b" /* default */], {
        ...
        return external_react_default.a.createElement(ItemList, null, data.items.map(function (item, index) {
          return external_react_default.a.createElement(components_Item, {
            key: index,
            item: item
          });
        }));
      }), external_react_default.a.createElement(Pagination["b" /* default */], {
        page: this.props.page
      }));
    }
  }]);
...
/* harmony import */ var _User__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
...
var PleaseSignin = function PleaseSignin(props) {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_1__["Query"], {
    ...
    if (!data.me) return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Please Sign In before Continuing"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_Signin__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], null));
...
/* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3);
/* harmony import */ var graphql_tag__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(graphql_tag__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
/* harmony import */ var next_router__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(next_router__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _styles_Form__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(10);
/* harmony import */ var _ErrorMessage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(6);
/* harmony import */ var _Items__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
/* harmony import */ var _Pagination__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(12);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 6;
                return fetch("https://api.cloudinary.com/v1_1/datfc97pro/image/upload", {
                  method: "POST",
                  body: data
                });
  ...
  _createClass(CreateItem, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react_apollo__WEBPACK_IMPORTED_MODULE_2__["Mutation"], {
        ...
        refetchQueries: function refetchQueries() {
          return [{
            query: _Items__WEBPACK_IMPORTED_MODULE_7__[/* ALL_ITEMS_QUERY */ "a"]
          }, {
            query: _Pagination__WEBPACK_IMPORTED_MODULE_8__[/* PAGINATION_QUERY */ "a"]
          }];
        }
...
var CreateItem = __webpack_require__(23);
...
var ALL_USER_QUERY = external_graphql_tag_default()(_templateObject2());

var Permissions_Permissions = function Permissions() {
  return external_react_default.a.createElement(external_react_apollo_["Query"], {
    ...
    var data = _ref.data,
        loading = _ref.loading,
        error = _ref.error;
    return external_react_default.a.createElement(external_react_default.a.Fragment, null, error && external_react_default.a.createElement(ErrorMessage["a" /* default */], {
      error: error
    }), external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "Manage Permissions"), external_react_default.a.createElement(styles_Table, null, external_react_default.a.createElement("thead", null, external_react_default.a.createElement("tr", null, external_react_default.a.createElement("th", null, "Name"), external_react_default.a.createElement("th", null, "Email"), possiblePermissions.map(function (item, index) {
      return external_react_default.a.createElement("th", {
        key: index
      }, item);
    }), external_react_default.a.createElement("th", null, "\uD83D\uDC47\uD83C\uDFFB"))), external_react_default.a.createElement("tbody", null, data.users && data.users.map(function (user, index) {
  ...
  function UserPermission() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (e) {
      ...
      if (checkbox.checked) {
        ...
        updatedPermissions = updatedPermissions.filter(function (item) {
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(external_react_default.a.Fragment, null, error && external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", {
          ...
          error: error
        }))), external_react_default.a.createElement("tr", null, external_react_default.a.createElement("td", null, user.name), external_react_default.a.createElement("td", null, user.email), possiblePermissions.map(function (item, index) {
          return external_react_default.a.createElement("td", {
            key: index
          }, external_react_default.a.createElement("label", {
            htmlFor: "".concat(user.id, "-permission-").concat(item)
          }, external_react_default.a.createElement("input", {
            type: "checkbox",
            checked: _this2.state.permissions.includes(item),
            onChange: _this2.handleChange,
            value: item,
            id: "".concat(user.id, "-permission-").concat(item)
          })));
