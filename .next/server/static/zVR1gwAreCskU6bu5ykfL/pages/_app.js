...
var endpoint = "https://supreme-yoga-prod.herokuapp.com";
var perPage = 4;
...
function (_Component) {
  ...
  function RemoveFromCart() {
    ...
    function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(cache, payload) {
        var data, cartItemId;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                cartItemId = payload.data.removeFromCart.id;
      ...
      return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
        ...
        return external_react_default.a.createElement(BigButton, {
          ...
          onClick: function onClick() {
            removeCartItem().catch(function (err) {
...
function CartItem_typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { CartItem_typeof = function _typeof(obj) { return typeof obj; }; } else { CartItem_typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return CartItem_typeof(obj); }
...
function CartItem_possibleConstructorReturn(self, call) { if (call && (CartItem_typeof(call) === "object" || typeof call === "function")) { return call; } return CartItem_assertThisInitialized(self); }

function CartItem_assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }

function CartItem_getPrototypeOf(o) { CartItem_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return CartItem_getPrototypeOf(o); }

function CartItem_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) CartItem_setPrototypeOf(subClass, superClass); }

function CartItem_setPrototypeOf(o, p) { CartItem_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return CartItem_setPrototypeOf(o, p); }
...
var CartItemSyles = external_styled_components_default.a.li.withConfig({
  displayName: "CartItem__CartItemSyles",
...
var CartItem_CartItem =
/*#__PURE__*/
function (_Component) {
  CartItem_inherits(CartItem, _Component);

  function CartItem() {
    CartItem_classCallCheck(this, CartItem);

    return CartItem_possibleConstructorReturn(this, CartItem_getPrototypeOf(CartItem).apply(this, arguments));
  }
  ...
  CartItem_createClass(CartItem, [{
    ...
    value: function render() {
      ...
      if (!cartItem.item) return external_react_default.a.createElement(CartItemSyles, null, external_react_default.a.createElement("p", null, "This Item has been removed!"), external_react_default.a.createElement(components_RemoveFromCart, {
        id: cartItem.id
      }));
      return external_react_default.a.createElement(CartItemSyles, null, external_react_default.a.createElement("img", {
        width: "100",
...
var external_react_adopt_ = __webpack_require__(27);

// EXTERNAL MODULE: external "react-stripe-checkout"
var external_react_stripe_checkout_ = __webpack_require__(28);
...
var external_nprogress_ = __webpack_require__(21);
...
var totalItems = function totalItems(cart) {
  return cart.reduce(function (item1, item2) {
      ...
      return external_react_default.a.createElement(User["b" /* default */], null, function (_ref2) {
        ...
        return external_react_default.a.createElement(external_react_apollo_["Mutation"], {
          ...
          return external_react_default.a.createElement(external_react_stripe_checkout_default.a, {
            ...
            name: "Supreme",
            description: "Oder of ".concat(totalItems(me.cart), " items!"),
...
var TOGGLE_CART_MUTAION = external_graphql_tag_default()(_templateObject2());
...
var Cart_Cart = function Cart(props) {
  return external_react_default.a.createElement(Composed, null, function (_ref4) {
    ...
    return external_react_default.a.createElement(styles_CartStyles, {
      ...
      onClick: toggleCart,
      title: "close"
    }, "\xD7"), external_react_default.a.createElement(styles_Supreme, null, me.name, "'s Cart"), external_react_default.a.createElement("p", null, "Have ", me.cart.length, " Item", me.cart.length === 1 ? "" : "s", " in your cart")), external_react_default.a.createElement("ul", null, me.cart.map(function (item, index) {
...
var AnimationSyles = external_styled_components_default.a.span.withConfig({
  displayName: "CartCount__AnimationSyles",
...
function CartCount(_ref) {
  ...
  return external_react_default.a.createElement(AnimationSyles, null, external_react_default.a.createElement(external_react_transition_group_["TransitionGroup"], null, external_react_default.a.createElement(external_react_transition_group_["CSSTransition"], {
    unmountOnExit: true,
    className: "count",
    classNames: "count",
    key: count,
  ...
  return external_react_default.a.createElement(User["b" /* default */], null, function (_ref) {
    ...
    return external_react_default.a.createElement(styles_NavStyles, null, external_react_default.a.createElement(link_default.a, {
      ...
      return external_react_default.a.createElement("button", {
        ...
        count: me.cart.reduce(function (item1, item2) {
          return item1 + item2.quantity;
        }, 0)
      }));
...
var external_downshift_ = __webpack_require__(26);
var external_downshift_default = /*#__PURE__*/__webpack_require__.n(external_downshift_);

// EXTERNAL MODULE: external "lodash.debounce"
var external_lodash_debounce_ = __webpack_require__(29);
      ...
      return external_react_default.a.createElement(SearchStyles, null, external_react_default.a.createElement(external_downshift_default.a, {
        ...
        return external_react_default.a.createElement("div", null, external_react_default.a.createElement(external_react_apollo_["ApolloConsumer"], null, function (client) {
          return external_react_default.a.createElement("input", getInputProps({
            type: "search",
            placeholder: "Seach For An Items",
...
var Header_Header = function Header() {
  return external_react_default.a.createElement(StyledHeader, null, external_react_default.a.createElement("div", {
    ...
    className: "sub-bar"
  }, external_react_default.a.createElement(components_Search, null)), external_react_default.a.createElement(components_Cart, null));
};
...
var external_apollo_boost_ = __webpack_require__(31);
...
function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; var ownKeys = Object.keys(source); if (typeof Object.getOwnPropertySymbols === 'function') { ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) { return Object.getOwnPropertyDescriptor(source, sym).enumerable; })); } ownKeys.forEach(function (key) { withData_defineProperty(target, key, source[key]); }); } return target; }
...
function withData_asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }

function withData_asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { withData_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { withData_asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
  ...
  return new external_apollo_boost_default.a({
    ...
    clientState: {
      resolvers: {
        Mutation: {
          toggleCart: function () {
            var _toggleCart = withData_asyncToGenerator(
            /*#__PURE__*/
            regenerator_default.a.mark(function _callee(_, variables, _ref2) {
              var cache, _ref3, cartOpen, data;
            ...
            function toggleCart(_x, _x2, _x3) {
              return _toggleCart.apply(this, arguments);
            }
