...
function (_Component) {
  ...
  function UpdateItem() {
    ...
    function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(e, updateItemMutaion) {
        var res;
  ...
  _createClass(UpdateItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (!data.item) return external_react_default.a.createElement("p", null, "No Item Found for ID notreal");
