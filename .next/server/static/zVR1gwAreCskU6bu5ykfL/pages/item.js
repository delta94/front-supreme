...
var SingleItemSyles = external_styled_components_default.a.div.withConfig({
  displayName: "SingleItem__SingleItemSyles",
  ...
  _createClass(SingleItem, [{
    ...
    value: function render() {
      ...
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (!item) return external_react_default.a.createElement("p", null, "No Item Found for ", _this.props.id);
        return external_react_default.a.createElement(SingleItemSyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Sick Fits | ", item.title)), external_react_default.a.createElement("img", {
          src: item.largeImage,
          alt: item.title
